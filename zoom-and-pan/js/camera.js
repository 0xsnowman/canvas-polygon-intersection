class Camera {
  ...
  generateIsoscelesTriangles(center, scale) {
    function createSectorPoints(center, radius, angleStart, angleEnd) {
    ...
    return {
      out_pol: createSectorPoints(
        center,
        scale * visionRangesValue[2],
        -toRadians(this.m_angle),
        toRadians(this.m_angle)
      ),
      in_pol1: createSectorPoints(
        center,
        scale * visionRangesValue[1],
        -toRadians(this.m_angle),
        toRadians(this.m_angle)
      ),
      in_pol2: createSectorPoints(
        center,
        scale * visionRangesValue[0],
        -toRadians(this.m_angle),
        toRadians(this.m_angle)
      ),
    };
